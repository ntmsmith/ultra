...
from pyUltrra.functions.parser import GoogleSearch, YahooSearch
...
async def repo(e):
    res = [
        await e.builder.article(
            ...
            text="• **ULTRA USERBOT** •",
            buttons=[
                [Button.url("Repo", url="https://github.com/TeamUltra/Ultra")],
                [Button.url("Support", url="t.me/UltraSupport")],
            ],
        )
    ]
    await e.answer(res)
