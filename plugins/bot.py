...
async def lol(ult):
    ...
    if pic is None:
        ...
        await ult.delete()
        await Ultra_bot.send_message(ult.chat_id, file=pic)
        await Ultra_bot.send_message(ult.chat_id, als)
...
async def _(ult):
    ...
    with open("logs-Ultra.txt", "w") as log:
    ...
    await xx.delete()
    return os.remove("logs-Ultra.txt")
