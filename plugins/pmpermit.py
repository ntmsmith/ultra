...
from pyUltra.functions.pmpermit_db import *
...
@Ultra_bot.on(events.NewMessage(incoming=True, func=lambda e: e.is_private))
...
if sett == "True" and sett != "False":
    ...
    @Ultra_bot.on(events.NewMessage(outgoing=True, func=lambda e: e.is_private))
    ...
    @Ultra_cmd(pattern="(da|disapprove)(?: |$)")
