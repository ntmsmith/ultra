...
Ultra_PIC = "https://telegra.ph/file/11245cacbffe92e5d5b14.jpg"
...
async def e(o):
    if len(o.text) == 0:
        ...
        res = [
                await b.article(
                title="Ultra Userbot",
                url="https://t.me/TeamUltra",
                description="Userbot | Telethon ",
                text=ALIVEMSG,
                thumb=InputWebDocument(Ultra_PIC, 0, "image/jpeg", []),
                buttons=[
                    [Button.url(text="Support Group", url="t.me/UltraSupport")],
                    [
                        Button.url(
                            text="Repo", url="https://github.com/TeamUltra/Ultra"
                        )
                    ],
                ],
            )
        ]
        await o.answer(res, switch_pm=f"👥 Ultra PORTAL", switch_pm_param="start")
...
if Var.BOT_USERNAME is not None and asst is not None:
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [
                        Button.url(
                            "⚙️Sᴇᴛᴛɪɴɢs⚙️",
                            url=f"https://t.me/{bnn}?start={Ultra_bot.me.id}",
                        )
                    ],
    ...
    async def opner(event):
        ...
        buttons = [
            ...
            [
                Button.url(
                    "⚙️Sᴇᴛᴛɪɴɢs⚙️", url=f"https://t.me/{bnn}?start={Ultra_bot.me.id}"
                )
            ],
            [Button.inline("••Cʟᴏꜱᴇ••", data="close")],
        ]
