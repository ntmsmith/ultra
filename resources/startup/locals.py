# /usr/bin/python3
# Ultra - UserBot
# Copyright (C) 2020 ntmsmith
#
# This file is a part of < https://github.com/ntmsmith/ultra/ >
# Please read the GNU Affero General Public License in
# <https://www.github.com/ntmsmith/ultra/blob/main/LICENSE/>.
...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to Ultra, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    try:
        os.system("git clone https://github.com/ntmsmith/ultra && cd Ultra")
    ...
    if isitdone == "y":
        # https://github.com/ntmsmith/ultra/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
        f.close
    elif isitdone == "n":
